...
/**
 * Records a custom event. A no-op when analytics is disabled or still loading.
 * 
 ...
 * it simply records the event if analytics is enabled and the client is initialized.
 * 
 */
